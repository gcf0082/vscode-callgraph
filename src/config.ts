...
export class Config {
  ...
  public get defaultLayout(): string { return this.getSetting<string>('defaultLayout', 'klay'); }
  public get nodeShape(): string { return this.getSetting<string>('nodeShape', 'round-rectangle'); }
